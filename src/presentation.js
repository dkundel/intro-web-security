...
const HASHTAGS = '#angularoslo #ndcoslo #websec';
const SLIDE_URL = 'd-k.im/sec-ngoslo';
      ...
      <div>
        ...
        <Deck theme={theme} progress="none">
          ...
          <Slide>
            ...
            <Image
              src={images.tweetJakeCss}
              height={300}
              alt="Tweet of Jake Archibal's tweet"
            />
            <p>
          ...
          <Slide>
            ...
            <List>
              ...
              <ListItem>
                Check out libraries like <Code>helmet</Code> for essential HTTP
                headers.
              </ListItem>
              <ListItem>
