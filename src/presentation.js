...
const images = {
  ...
  meHeart: require('./assets/me-heart.png'),
  ...
  equifax: require('./assets/equifax.jpg'),
  tweetJakeCss: require('./assets/tweet-jake-css.png'),
  confusedStarWars: require('./assets/confused-starwars.gif'),
  icons: {
    ...
    return <div>
        ...
        <Deck theme={theme} progress="none">
          <Slide bgImage={images.matrixWallpaper} bgDarken={0.5}>
            ...
            <Heading size={4}>
              Dominik Kundel - <Link href="https://twitter.com/dkundel">
                @dkundel
              </Link>
            </Heading>
          ...
          <Slide bgColor="black">
            <LargeNotes>
              ...
              <ul>
                ...
                <li>
                  Enable network proxy with http://localhost:2000/proxy.pac
                </li>
                <li>hotel start</li>
          ...
          <Slide bgImage={images.matrixWallpaper} bgDarken={0.5}>
            ...
            <LargeNotes>
              ...
              introduction to web security. And while this talk won't make
              you a web security expert, it will cover things that in my
              opinion every web developer should know and be aware off.
            </LargeNotes>
          </Slide>
          <Slide>
          ...
          <Slide>
            <Layout>
              ...
              <Fill style={{ marginLeft: '5rem', textAlign: 'center' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '50px', textAlign: 'center' }}>
                  <LinkedImage src={images.icons.github} height="80px" href="https://github.com/dkundel">
                    <Text textSize="1.3rem">github/dkundel</Text>
                  </LinkedImage>
                  <LinkedImage src={images.icons.twitter} height="80px" href="https://twitter.com/dkundel">
                    <Text textSize="1.3rem">@dkundel</Text>
                  </LinkedImage>
                  <LinkedImage src={images.icons.email} height="80px" href="mailto:dkundel@twilio.com">
            ...
            <LargeNotes>
              But first let me introduce myself. I'm Dominik.You can reach
              me pretty much everywhere on the internet under @dkundel. I
              live in Berlin and I work as a developer evangelist at Twilio.
            </LargeNotes>
          </Slide>
          <Slide bgColor="black">
            <LargeNotes>
          ...
          <Slide bgImage={images.onesieJs} bgSize="contain" bgRepeat="no-repeat">
            <Heading bgColor="darkBlue" caps={false} style={{ display: 'inline-block' }} padding={20}>
              #onesiejs
            </Heading>
            <LargeNotes>
              I'm a member of a group of onesie loving JavaScript
              developers. Also known as #onesiejs
            </LargeNotes>
          </Slide>
          <Slide bgImage={images.socialMediaWallpaper}>
            <LargeNotes>
              Today we have so many social networks and communication
              channels.But there isn 't really one for onesie loving
              developers.
            </LargeNotes>
          </Slide>
          ...
          <Slide>
            ...
            <LargeNotes>
              It uses HTTPS 100% for free thanks to Let's Encrypt, it uses
              HSTS, doesn't allow mixed content, I sanitize the HTML input
              that the users can do via Markdown and don't allow room for
              any SQL injections.
            </LargeNotes>
          </Slide>
          <Slide>
            ...
            <LargeNotes>
              ...
              NoSQL injections but we won't have time to dig into these
              today.
            </LargeNotes>
          </Slide>
          <Slide bgColor="black">
            <LargeNotes>
              Turns out developing secure web applications isn 't as easy as
              I thought.
            </LargeNotes>
          </Slide>
          <Slide>
            ...
            <LargeNotes>
              ...
              found a bunch of vulnerabilites that I wanted to share with
              you
            </LargeNotes>
          </Slide>
          <Slide>
            <div>
              <LinkedImage src={images.onesieScreenshot} width="80%" href="https://onesie-life.localhost" rel="noopener noreferrer" target="_blank" />
            </div>
            <Link href="https://onesie-life.localhost" rel="noopener noreferrer" target="_blank">
          ...
          <Slide>
            ...
            <CodePane lang="javascript" source={require('!!raw-loader!./snippets/http-only-cookie.js')} />
            <LargeNotes>
              You should make sure to mark cookies you don 't have to access
              in JS always as HttpOnly
            </LargeNotes>
          </Slide>
          <Slide>
            <Heading size={2}>
            ...
            <CodePane lang="javascript" source={require('!!raw-loader!./snippets/jwt-algorithm.js')} />
            <LargeNotes>
          ...
          <Slide bgImage={images.equifax} bgSize="cover" bgRepeat="no-repeat" bgDarken={0.7}>
            <Heading size={3}>Don't be the next Equifax</Heading>
            <Heading>
              <em style={{ textTransform: 'none' }}>Stay up-to-date!</em>
            </Heading>
            <Text style={{ fontSize: '0.8em', textAlign: 'right' }}>
              Image: Michael Nagle/Bloomberg via Getty Images
            </Text>
          </Slide>
          <Slide>
            <Heading size={2}>Let's post something!</Heading>
            <ResourceLinkWithIcon url="onesie-life.localhost/home" icon={images.icons.desktopCode} text="onesie.life Feed" />
            <LargeNotes>
          ...
          <Slide>
            ...
            <ResourceLinkWithIcon url="hack-onesie.glitch.me/xsrf" icon={images.icons.hacker} />
            <LargeNotes>
              Now the danger of POST requests is that an attacker can use
              them to perform so call CSRF attacks. Let's take a look at how
              this works.
            </LargeNotes>
          </Slide>
          <Slide>
            ...
            <LargeNotes>
              Alright so before we talk about how we can protect ourselves
              from CSRF attacks, let's talk about what just happened.
            </LargeNotes>
          </Slide>
          <Slide>
            <Heading size={2}>
            ...
            <CodePane lang="javascript" source={require('!!raw-loader!./snippets/opener-redirect.js')} />
            <LargeNotes>
              When we opened the Glitch page it was able to access the page
              that opened it and manipulate it's URL. In our case we
              navigated it to a harmless page but it could redirect it as
              well to a phishing page without the user noticing.
            </LargeNotes>
          </Slide>
          <Slide>
            <Heading size={2}>
            ...
            <CodePane lang="html" source={require('!!raw-loader!./snippets/noopener.html')} />
            <LargeNotes>
              We can avoid this by using the rel attribute. noopener works
              in all modern browsers but IE and Edge. You could
              alternatively use a framebuster script however it can be
              easily circumvented.
            </LargeNotes>
          </Slide>
          <Slide>
            ...
            <CodePane className="line-numbers" lang="javascript" source={require('!!raw-loader!./snippets/csrf-tokens.js')} />
            <LargeNotes>
              Alright let's talk again about CSRF. Make sure to use CSRF
              tokens for your POST requests to avoid these types of attacks.
              Basically the idea is that we set a value in a cookie that is
              either transmitted via a header or via the POST body. The idea
              is that the cookie is automatically transferred but the other
              ones have to be set manually.
            </LargeNotes>
          </Slide>
          {/* <Slide>
          ...
          <Slide>
            ...
            <LargeNotes>
              Alright let's talk about Little Bobby Tables young brother.
              Samy the XSS attack.
            </LargeNotes>
          </Slide>
          <Slide>
            ...
            <LargeNotes>
              ...
              have SQL injections in their mind, less people think about XSS
              as a danger. And especially not how much harder it is to
              block.
            </LargeNotes>
          </Slide>
          <Slide bgImage={images.samyWorm} bgSize="contain" bgRepeat="no-repeat">
            <LargeNotes>
              This is the source code of a very famous XSS attack.
            </LargeNotes>
          </Slide>
          <Slide bgImage={images.samyWorm} bgSize="contain" bgRepeat="no-repeat" bgDarken={0.7}>
          ...
          <Slide>
            ...
            <CodePane lang="html" source={require('!!raw-loader!./snippets/samy-move-code.html')} />
            <CodePane lang="javascript" source={require('!!raw-loader!./snippets/samy-join-strings.js')} />
            <Link href="http://samy.pl/popular/tech.html" style={{ marginTop: '2rem' }}>
              <Text>samy.pl/popular/tech.html</Text>
            </Link>
            <LargeNotes>
              MySpace did a lot of work trying to block XSS attacks.
              However, Samy used a bunch of tricks to get around it. These
              are just two tricks that Samy used for his XSS attack.
            </LargeNotes>
          </Slide>
          <Slide>
            ...
            <LargeNotes>
              Leaving aside this there is a lot of ways to achieve
              obstrusive JavaScript. This is just an example of different
              ways to achieve eval. The last one is actually generated by a
              project that allows you to write any JavaScript with just 6
              characters.
            </LargeNotes>
          </Slide>
          <Slide>
            <Heading size={2}>Blocking XSS Is Not Trivial</Heading>
            <ResourceLinkWithIcon url="onesie-life.localhost/home" icon={images.icons.desktopCode} text="onesie.life" />
            <LargeNotes>
              The bottom line here is that XSS is not trivial to block.
              Let's see an example in the onesie.life app. DEMO.
            </LargeNotes>
          </Slide>
          <Slide>
            <Heading>
              Encoding can be <em style={{ textTransform: 'none' }}>
                dangerous
              </em>!
            </Heading>
            <LargeNotes>
              So we've seen here that encoding can be incredibly dangerous
              since it significantly increases the ways that we can approach
              things. Especially if the browser as quirkynesses like the one
              we've seen.
            </LargeNotes>
          </Slide>
          <Slide>
            <Heading size={2}>CSS can be dangerous!</Heading>
            <Image src={images.tweetJakeCss} height={300} alt="Tweet of Jake Archibal's tweet" />
            <p>
              <Link href="https://twitter.com/jaffathecake/status/968500192210227202">
                twitter.com/jaffathecake/status/968500192210227202
              </Link>
            </p>
          </Slide>
          {/* <Slide>
          ...
          <Slide>
            ...
            <CodePane lang="html" source={require('!!raw-loader!./snippets/jsonp-example.html')} />
            <LargeNotes>
          ...
          <Slide>
            ...
            <ResourceLinkWithIcon url="onesie-life.localhost" text="onesie.life" icon={images.icons.desktopCode} />
            <LargeNotes>
              The problem is that a poorly implemented JSONP in combination
              with an XSS vulnerability can create a very dangerous attack
              vector thanks to Service Workers. DEMO.
            </LargeNotes>
          </Slide>
          <Slide>
            ...
            <LargeNotes>
              So far we've seen several different XSS attacks and we should
              fix all of these if we have them in our applications. But
              luckily there is a new superhero in town that can help us with
              this. The name of this super hero is CSP or
              Content-Security-Policy.
            </LargeNotes>
          </Slide>
          <Slide>
            <Heading size={2}>CSP Demo</Heading>
            <ResourceLinkWithIcon text="onesie.life/secure/home" url="onesie-life.localhost/secure/home" icon={images.icons.desktopCode} />
            <LargeNotes>
          ...
          <Slide>
            ...
            <CodePane lang="http" source={require('!!raw-loader!./snippets/csp-header.snippet')} />
            <LargeNotes>
          ...
          <Slide>
            ...
            <LargeNotes>
              The important thing to keep in your mind is that CSP should
              not be your security strategy but you should rather treat it
              as a safety net.
            </LargeNotes>
          </Slide>
          <Slide>
            ...
            <List>
              <ListItem>
                Avoid clickjacking by disallowing framing using <Code>
            ...
            <LargeNotes>
              So we've seen a bunch of things we should keep an eye on for
              our web applications. A few other ones to consider are.
            </LargeNotes>
          </Slide>
          <Slide>
            ...
            <LargeNotes>
              Additionally you should consider a regular security audit for
              your applications if you don't have a security expert on your
              crew.
            </LargeNotes>
          </Slide>
          <Slide>
          ...
          <Slide>
            <ResourceLinkWithIcon url="bit.ly/onesie-life" icon={images.icons.github} />
            <LargeNotes>
              Additionally you can check out the source code of the
              onesie.life page including documentation of all the
              vulnerabilities in the GitHub repo. If you find additional
              vulnerabilities, please feel free to create an issue on
              GitHub. I believe security is all about learning new things
              and sharing them
            </LargeNotes>
          </Slide>
          <Slide>
            ...
            <Layout>
              ...
              <Fill style={{ marginLeft: '5rem', textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                ...
                <div style={{ marginTop: '50px' }}>
                  <Link href={'https://' + SLIDE_URL} rel="noopener noreferrer" target="_blank">
                    <Text>{SLIDE_URL}</Text>
                  </Link>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '50px', textAlign: 'center' }}>
